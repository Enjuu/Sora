...
namespace Sora.Objects.Multiplayer
{
    ...
    public class Match : PresenceKeeper, ISerializer
    {
        ...
        public void Invite(Presence sender, Presence receiver,
            string msg = "Hey, I want to play with you! Join me [%INVITE_URI% %MATCH_NAME%]")
        {
