...
namespace Sora.Utilities
{
    public static class Localisation
    {
        public static void Initialize()
        {
            ...
            Logger.Fatal(
                $"Couldn't find GeoLite2-City database at {Directory.GetCurrentDirectory()}/geoip/GeoLite2-City/GeoLite2-City.mmdb");
        }
        ...
        public static CountryId StringToCountryId(string x) =>
            Enum.TryParse(x, true, out CountryId o) ? o : CountryId.XX;
